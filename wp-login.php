...
<html lang="ja">
	...
	<title>ログイン &lsaquo; ごろのごろごろメモ &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.1.1" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://192.168.1.15/wordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="ログイン">
									<input type="hidden" name="redirect_to" value="http://192.168.1.15/wordpress/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a href="/wp-login.php?action=lostpassword">パスワードをお忘れですか ?</a>			</p>
...
<option value="ja" lang="ja" selected data-installed="1">日本語</option></select>
...
<script id="zxcvbn-async-js-extra">var _zxcvbnSettings = {"src":"http:\/\/192.168.1.15\/wordpress\/wp-includes\/js\/zxcvbn.min.js"};</script>
...
<script id="password-strength-meter-js-extra">var pwsL10n = {"unknown":"パスワード強度不明","short":"非常に脆弱","bad":"脆弱","good":"普通","strong":"強力","mismatch":"不一致"};</script>
<script id="password-strength-meter-js-translations">( function( domain, translations ) {
	var localeData = translations.locale_data[ domain ] || translations.locale_data.messages;
	localeData[""].domain = domain;
	wp.i18n.setLocaleData( localeData, domain );
} )( "default", {"translation-revision-date":"2022-11-15 02:07:47+0000","generator":"GlotPress\/4.0.0-alpha.3","domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural-forms":"nplurals=1; plural=0;","lang":"ja_JP"},"%1$s is deprecated since version %2$s! Use %3$s instead. Please consider writing more inclusive code.":["%1$s はバージョン%2$sより非推奨になりました。かわりに %3$s を利用してください。より包括的なコードを書くことを検討してください。"]}},"comment":{"reference":"wp-admin\/js\/password-strength-meter.js"}} );</script>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"4d111c9163"};</script>
<script id="user-profile-js-translations">( function( domain, translations ) {
	var localeData = translations.locale_data[ domain ] || translations.locale_data.messages;
	localeData[""].domain = domain;
	wp.i18n.setLocaleData( localeData, domain );
} )( "default", {"translation-revision-date":"2022-11-15 02:07:47+0000","generator":"GlotPress\/4.0.0-alpha.3","domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural-forms":"nplurals=1; plural=0;","lang":"ja_JP"},"Your new password has not been saved.":["新しいパスワードは、保存されていません。"],"Hide":["非表示"],"Show":["表示"],"Confirm use of weak password":["脆弱なパスワードの使用を確認"],"Hide password":["パスワードを隠す"],"Show password":["パスワードを表示"]}},"comment":{"reference":"wp-admin\/js\/user-profile.js"}} );</script>
